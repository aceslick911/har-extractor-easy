...
var fPaths = [];
var hasSameName = function (file) { return fPaths.includes(file); };
...
var filteredMap = knownMimeMap.reduce(function (acc, curr) {
    var _a;
    return (__assign(__assign({}, (acc || {})), (_a = {}, _a[curr.key] = curr, _a)));
}, {});
var mimeMap = __assign(__assign({}, filteredMap), { "application/json": {
        extension: ".json",
...
export var extract = function (harContent, options) {
    harContent.log.entries.forEach(function (entry) { return __awaiter(void 0, void 0, void 0, function () {
        var buffer, _a, uniquePath, updatedBuffer, outputPath;
        return __generator(this, function (_b) {
            buffer = getEntryContentAsBuffer(entry);
            if (!buffer) {
                return [2 /*return*/];
            }
            _a = convertEntryAsFilePathFormat(buffer, entry, options.removeQueryString), uniquePath = _a.uniquePath, updatedBuffer = _a.updatedBuffer;
            outputPath = uniqueFile(path.join(options.outputDir, uniquePath));
